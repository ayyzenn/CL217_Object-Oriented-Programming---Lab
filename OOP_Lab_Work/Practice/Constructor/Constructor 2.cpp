...
ClassRoom::ClassRoom(int id,int NOC,char c,string mul, string remks)
{
    ...
    this->setremarks(remks+"\tConstructor with All(5)Parameters (ID,NOC,BoardType,Multimedia,Remarks)");
    ...
    // this->boardType=c;
    // this->multimedia=mul;
    // this->remarks=remks+"\tConstructor with All(5)Parameters (ID,NOC,BoardType,Multimedia,Remarks)";
}
//---------------------------------------Setter Functions
